...
<!-- Banner Section -->
<div class="banner">
  <img src="kespalogo1.png" alt="KESPA Logo" style="height: 250px;">
...
<section id="tujuan">
  <h2>Tujuan Kesatuan KESPA</h2>
  <p>Kesatuan KESPA ditubuhkan bagi memperjuangkan hak pekerja, memperbaiki kebajikan ahli, dan memastikan persekitaran kerja yang adil dan selamat.</p>
</section>

<div class="divider"></div>

<section id="peranan">
  <h2>Peranan Kesatuan KESPA</h2>
  <ul>
    <li>Melindungi kepentingan pekerja.</li>
    <li>Memberi khidmat nasihat dan bantuan guaman.</li>
    <li>Menjadi pengantara dalam rundingan dengan majikan.</li>
    <li>Memastikan pematuhan undang-undang buruh.</li>
  </ul>
</section>
...
<section id="aktiviti">
  <h2>Aktiviti Kesatuan KESPA</h2>
  <p>Beberapa aktiviti utama kesatuan termasuk seminar hak pekerja, perjumpaan tahunan ahli, dan perarakan aman.</p>
  <div class="media-container">
    <img src="aktiviti1.jpg" alt="Gambar Aktiviti 1">
    <video controls>
      <source src="laguKespa1.mp4" type="video/mp4">
    </video>
  </div>
</section>
...
<section id="berita">
  <h2>Berita Kejayaan Kesatuan</h2>
  <p>Kesatuan KESPA telah berjaya menuntut bayaran lebih masa yang adil untuk ahli, serta memperolehi cuti tahunan tambahan bagi pekerja dalam sektor tertentu.</p>
</section>

<div class="divider"></div>

<section id="halehwal">
  <h2>Hal Ehwal Kesatuan</h2>
  <p>KESPA sentiasa berusaha menjalinkan kerjasama dengan badan kerajaan dan NGO untuk memperkukuh hak pekerja dan menjalankan kajian terhadap kesejahteraan pekerja di Malaysia.</p>
</section>
